...
urlpatterns=[
    ...
    path('password-reset/',auth_views.PasswordResetView.as_view(
        ...
        success_url='/account/password-rest-done/'),
         name='password_reset'),
    path('password/',auth_views.PasswordResetDoneView.as_view(template_name='account/password_reset_done.html'),name='password_reset_done'),
    ...
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name="account/password_reset_complete.html"),name='password_reset_password'),
